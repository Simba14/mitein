...
const content = [
  { text: 'Terms of Use', type: HEADING },
  { text: 'Last updated April 26, 2022', type: PARAGRAPH },
  {
  ...
  { text: '2. INTELLECTUAL PROPERTY RIGHTS', type: SENTENCE },
  {
  ...
  { text: '6. USER GENERATED CONTRIBUTIONS', type: SENTENCE },
  { text: '7. CONTRIBUTION LICENSE', type: SENTENCE },
  { text: '8. SUBMISSIONS', type: SENTENCE },
  { text: '9. THIRD-PARTY WEBSITE AND CONTENT', type: SENTENCE },
  { text: '10. SITE MANAGEMENT', type: SENTENCE },
  {
    text: '11. PRIVACY POLICY',
    type: SENTENCE,
  },
  { text: '12. TERM AND TERMINATION', type: SENTENCE },
  { text: '13. MODIFICATIONS AND INTERRUPTIONS', type: SENTENCE },
  {
    text: '14. GOVERNING LAW',
    type: SENTENCE,
  },
  {
    text: '15. DISPUTE RESOLUTION',
    type: SENTENCE,
  },
  {
    text: '16. CORRECTIONS',
  ...
  {
    text: '21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES',
    type: SENTENCE,
  },
  {
    text: '22. MISCELLANEOUS',
    type: SENTENCE,
  },
  {
    text: '23. CONTACT US',
  ...
  { text: '1. AGREEMENT TO TERMS', type: TITLE },
  {
    text: 'These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and Mitein ("Company," “we," “us," or “our”), concerning your access to and use of the http://www.mitein.de website as well as any other media form, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Site”). We are registered in Germany and have our registered office at Legiendamm, 34, Berlin, Berlin 10969. You agree that by accessing the Site, you have read, understood, and agreed to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE IMMEDIATELY.',
    type: PARAGRAPH,
  },
  {
  ...
  { text: '2. INTELLECTUAL PROPERTY RIGHTS', type: TITLE },
  {
  ...
  { text: '6. USER GENERATED CONTRIBUTIONS', type: TITLE },
  {
  ...
  { text: '7. CONTRIBUTION LICENSE', type: TITLE },
  {
  ...
  { text: '9. THIRD-PARTY WEBSITE AND CONTENT', type: TITLE },
  {
  ...
  { text: '10. SITE MANAGEMENT', type: TITLE },
  {
  ...
  {
    text: 'We care about data privacy and security. Please review our Privacy Policy: http://www.mitein.de/privacy. By using the Site, you agree to be bound by our Privacy Policy, which is incorporated into these Terms of Use. Please be advised the Site is hosted in the United States. If you access the Site from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States, then through your continued use of the Site, you are transferring your data to the United States, and you agree to have your data transferred to and processed in the United States.',
    type: PARAGRAPH,
  },
  { text: '12. TERM AND TERMINATION', type: TITLE },
  {
  ...
  { text: '13. MODIFICATIONS AND INTERRUPTIONS', type: TITLE },
  {
  ...
  {
    text: 'These conditions are governed by and interpreted following the laws of Germany, and the use of the United Nations Convention of Contracts for the International Sale of Goods is expressly excluded. If your habitual residence is in the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the law of your country of residence. Mitein and yourself both agree to submit to the non-exclusive jurisdiction of the courts of Berlin, which means that you may make a claim to defend your consumer protection rights in regards to these Conditions of Use in Germany, or in the EU country in which you reside.',
    type: PARAGRAPH,
  },
  {
    text: '15. DISPUTE RESOLUTION',
  ...
  {
    text: 'Any dispute arising from the relationships between the Parties to this contract shall be determined by one arbitrator who will be chosen in accordance with the Arbitration and Internal Rules of the European Court of Arbitration being part of the European Centre of Arbitration having its seat in Strasbourg, and which are in force at the time the application for arbitration is filed, and of which adoption of this clause constitutes acceptance. The seat of arbitration shall be Berlin, Germany. The language of the proceedings shall be English. Applicable rules of substantive law shall be the law of Germany.',
    type: PARAGRAPH,
  },
  {
    text: 'Restrictions',
