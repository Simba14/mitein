...
const addOrganization = async () => {
  try {
    await docRef.set({
      ...
      description: {
        de:
          'Wohltätigkeitsorganisation, die Menschen, die vor Krieg, Armut, Verfolgung und Klimawandel fliehen und in Nordfrankreich und Großbritannien leben, nahrhaftes Essen ohne Wertung serviert.',
        en:
          'Charity serving nutritious food without judgement to those fleeing war, poverty, persecution and climate change and living in Northern France and the UK.',
      },
      email: 'volunteering@refugeecommunitykitchen.org',
      logo:
        '//static1.squarespace.com/static/59a7eed512abd9e692dbe3f2/t/6021b57e5796c01b02a1bbe7/1614425928550/?format=1500w',
